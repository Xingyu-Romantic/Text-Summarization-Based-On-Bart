...
class Predict:
    def __init__(self, model_name = './output/Final_bart.pdparams'):
    ...
    def postprocess_response(self, seq, bos_idx, eos_idx):
        ...
        res = self.tokenizer.convert_ids_to_string(seq)
        return res

    def predcit(self, inputs):
        ...
        outputs, _ = self.model.generate(
            ...
            max_length=50,
            use_faster=True)
        result = self.postprocess_response(outputs[0].numpy().tolist(), bos_id, eos_id)
